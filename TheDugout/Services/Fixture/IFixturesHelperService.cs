...
namespace TheDugout.Services.Fixture
{
    ...
    {
        Models.Fixtures.Fixture CreateFixture(int gameSaveId, int seasonId, int homeTeamId, int awayTeamId, DateTime date, int round, CompetitionType competitionType, CupRound? cupRound = null, int? leagueId = null, int? europeanCupPhaseId = null);
        ...
        string GetRoundName(int teamsCount, int roundNumber, int totalRounds);
